          ...
          <div class="row">
            ...
            <div class="screen">
              ...
              <div class="screen-right" style="overflow-y:scroll;">
                <h3 style="margin: 0; padding: 0; margin-top: 20px; margin-left: 10px;">Course Order</h3>
                <style type="text/css">
                  table {
                    width: 90%;
                    margin-left: 10px;
                ...
                ?>
                    ...
                    <tr>
                      ...
                      <td style="border-radius: 0px 10px 10px 0px;"><a href="download_video.php?cID=<?php echo $courseID;?>&epID=<?php echo $row['ID'];?>"><i class="fas fa-download"></i></a></td>
                    </tr>
