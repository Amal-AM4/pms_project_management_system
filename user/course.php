        ...
        <div class="content-wrapper">
          ...
          <div class="body-wrapper">
            ...
            <div class="box-wrapper">
              <table class="table">
                <?php
                  $sel = "SELECT tbl_course_order.COURSE_ID AS COURSE_ID,tbl_course.TITLE AS NAME,tbl_course.LOGS AS DT FROM tbl_course_order,tbl_course WHERE tbl_course_order.COURSE_ID=tbl_course.ID AND tbl_course_order.USER_ID = '$u_ID'";
                  $sel_exe = mysqli_query($conn, $sel);
                  $sn_no = 1;
                  while ($r = mysqli_fetch_assoc($sel_exe)) 
                  {
                ?>
                    <tr>
                      ...
                      <td><?php echo $r['DT'];?></td>
                      <td><a href="video_room.php?courseID=<?php echo $r['COURSE_ID'];?>"><i class="far fa-eye"></i></a></td>
                    </tr>
                <?php
                  $sn_no ++;
                  }
