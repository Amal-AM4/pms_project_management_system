          ...
          <div class="body-wrapper">
            ...
            <table class="table">
              <thead>
                ...
                <?php
                  $sel = "SELECT tbl_course.TITLE AS TITLE,tbl_course_order.LOGS AS DT,tbl_course.DIS_PRICE AS PRICE,tbl_user.FULL_NAME AS NAME FROM tbl_team,tbl_user,tbl_course,tbl_course_order WHERE tbl_course_order.COURSE_ID=tbl_course.ID AND tbl_course.EMP_ID='$e_id' AND tbl_course_order.USER_ID=tbl_user.ID AND tbl_team.ID='$e_id'";
