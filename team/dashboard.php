      ...
      <div class="main-panel">
        <div class="content-wrapper">
          ...
          <div class="body-wrapper">
            ...
            <div class="card">
              <div class="card-body">
                <h3 class="card-title"><a href="user_profile.php" class="btn btn-outline-primary btn-fw">Update</a></h3>
                <p class="card-description">Please update your profile for adding courses. You can also change the default user id and password.</p>
              </div>
            </div>
            <br>
              ...
              <div class="col-md-4 mb-4 stretch-card transparent">
                <div class="card card-tale">
                  <div class="card-body">
                    <p>Total earning</p>
                    <?php
                $pay = "SELECT tbl_course.DIS_PRICE AS PRICE1, SUM(tbl_course.DIS_PRICE) AS P1 FROM tbl_course WHERE tbl_course.EMP_ID='$tid'";
              ...
              <div class="col-md-4 mb-4 stretch-card transparent">
                <div class="card card-dark-blue">
                  <div class="card-body">
                    <p>Avg earning</p>
                    <?php
                $pay = "SELECT tbl_course.DIS_PRICE AS PRICE1, AVG(tbl_course.DIS_PRICE) AS P2 FROM tbl_course WHERE tbl_course.EMP_ID='$tid'";
              ...
              <div class="col-md-4 mb-4 stretch-card transparent">
                <div class="card card-light-blue">
                  <div class="card-body">
                    <p>Total Course</p>
                    <?php
                      $count = "SELECT COUNT(ID) AS INZC FROM tbl_course WHERE tbl_course.EMP_ID='$tid'";
