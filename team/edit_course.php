...
if (isset($_POST['submit'])) 
{
  ...
  if (empty($act_price)) {
      ...
      Redirect_To('edit_course.php?'.'courseID='.$courseID);
  }
  ...
  if (!empty($dic_price) AND !empty($act_price) AND !empty($post_content)) 
  {
    $update = "UPDATE `tbl_course` SET `POST_CONTENT`='$post_content',`ACT_PRICE`='$act_price',`DIS_PRICE`='$dic_price' WHERE ID = '$courseID'";
          ...
          <div class="body-wrapper">
            ...
            <form action="" method="post">
              ...
              <span>Amount</span>
                <div class="row">
                  <?php 
                    $sel = "SELECT ACT_PRICE,DIS_PRICE,POST_CONTENT FROM `tbl_course` WHERE ID = '$courseID'";
                    $exe = mysqli_query($conn, $sel);
                    $r = mysqli_fetch_assoc($exe);
                  ?>
                  <div class="col-6">
                      <input type="text" class="form-control" name="price" value="<?php echo $r['ACT_PRICE'];?>">
                  </div>
                  <div class="col-6">
                      <input type="text" class="form-control" name="dic_price" value="<?php echo $r['DIS_PRICE'];?>">
                  </div>
                </div>
                <div class="form-group">
                  <span>Course Description</span>
                  <textarea class="tinymce" name="post_content"><?php echo $r['POST_CONTENT'];?></textarea>
                </div>
                <button type="submit" name="submit" class="btn btn-block btn-info">Update Details</button>
            </form>
