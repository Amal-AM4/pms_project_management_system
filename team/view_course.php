           ...
           <div class="body-wrapper">
                    ...
                    <table class="table table-hover">
                      <thead>
                        ...
                        <?php
                            $sql = "SELECT tbl_course.ID AS IDD,tbl_course.TITLE AS TITLE,tbl_course.ACT_PRICE AS ACT_PRICE,tbl_course.DIS_PRICE AS DIS_PRICE,tbl_course.LOGS AS LOGS FROM `tbl_course`,`tbl_team` WHERE tbl_course.EMP_ID=tbl_team.ID AND tbl_team.ID = '$c'";
                            $sn = 1;
                        ...
                        <tr>
                            ...
                            <td><a href="edit_course.php?courseID=<?php echo $id;?>"><i class="far fa-edit"></i></a></td>
