      ...
      <div class="main-panel">
        <div class="content-wrapper">
          ...
          <div class="body-wrapper">
            <h2>User profile</h2><hr><br>
            <div class="row">
              <div class="col-md-4 grid-margin stretch-card">
                <div class="card" style="text-align: center;">
                  <div class="card-body">
                    <div class="card-title">Profile Data</div><hr>
                    <div class="card-description">
                      <?php
                        $sel = "SELECT * FROM `tbl_team` WHERE ID = '$tid'";
                        $s = mysqli_query($conn,$sel);
                        $s1 = mysqli_fetch_assoc($s);
                      ?>
                      <h4>Name: <?php echo $s1['NAME'];?></h4>
                      <p>Status: Active</p>
                      <p>EMAIL ID: <?php echo $s1['EMAIL'];?></p>
                      <p>Qualification: <?php echo $s1['DEPT'];?></p>
                      <p>User ID: <?php echo $s1['USER_ID'];?></p>
                      <p>Created: <?php echo $s1['LOGS'];?></p>
                      <a href="cpass.php">Change user id and password</a><br>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div class="col-md-8 grid-margin stretch-card">
                <div class="card" style="text-align: justify;">
                  <div class="card-body">
                    <div class="card-title">About <small><a href="edit_about.php">Edit</a></small></div><hr>
                    <div class="card-description">
                      <p><?php echo $s1['ABOUT'];?></p>
                    </div>
                  </div>
                </div>
              </div>
