        ...
        <div class="content-wrapper">
          ...
          <div class="body-wrapper">
            <div class="content-bz">
                <div class="row">
                  <div class="col-3"><h2 class="d-inline">Company Profile</h2></div>
                  <div class="col-9"><a href="edit-profile.php"><button class="btn btn-success"><i class="far fa-edit"></i> Edit</button></a></div>
                </div>
                <hr>
                <div class="wapper text-justify" style="margin-left: 10px;">
                    <?php
                        $info = "SELECT * FROM `tbl_companies` WHERE USER_ID = '$USER_ID";
                        $res = mysqli_query($conn, $sql);
                        $row = mysqli_fetch_assoc($res); 
                    ?>
                    <h5><?php echo $row['COMP_NAME'];?></h5>
                    <h6>Manager : <?php echo$row['MANAGER_NAME'];?></h6>
                    <h6>User id : <?php echo$row['USER_ID'];?></h6>
                    <h5><?php echo $row['ADDRESS'];?></h5>
                    <h6>E-mail : <?php echo $row['EMAIL'];?></h6>
                    <h6>Phone-no : <?php echo $row['PHONE'];?></h6>
