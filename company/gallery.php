...
<?php
  if (isset($_POST['submit'])) 
  {
    ...
    if (in_array($fileActualExt, $allowed)) {
      ...
      $insert = "INSERT INTO `tbl_gallery`(`COMP_ID`, `PHOTO`, `LOGS`) VALUES ('$c_id','$fileDes',now())";
      ...
      <div class="main-panel">
        <div class="content-wrapper">
          ...
          <div class="body-wrapper">
            ...
            <div class="gallery">
              <?php
                $img = "SELECT * FROM `tbl_gallery` WHERE COMP_ID = '$c_id'";
                $execute = mysqli_query($conn, $img);
                while ($r = mysqli_fetch_assoc($execute)) 
                {
              ?>
                <div class="box">
                  <img src="<?php echo $r['PHOTO']; ?>" width="230" height="140">
                </div>
              <?php
                }
              ?>
