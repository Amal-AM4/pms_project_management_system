          ...
          <div class="body-wrapper">
            ...
            <table class="table">
              <thead>
                ...
                <?php
                  $s = "SELECT tbl_user.FULL_NAME AS NAME,tbl_course.TITLE AS TITLE,tbl_course.DIS_PRICE AS PRICE,tbl_course_order.CARD_NO AS CARDNO,tbl_course_order.EXP_DATE AS EXP,tbl_course_order.LOGS AS DT FROM tbl_user,tbl_course,tbl_course_order WHERE tbl_course_order.USER_ID=tbl_user.ID AND tbl_course_order.COURSE_ID=tbl_course.ID AND tbl_course_order.COMPY_ID = '$c_id'";
