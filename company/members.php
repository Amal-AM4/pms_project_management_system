      ...
      <div class="main-panel">
        <div class="content-wrapper">
          <div class="body-wrapper">
                    <h2>Team Members</h2>
                    <p>Crew members in this company.</p>
                    ...
                    <table class="table" style="width: 90%;">
                      ...
                      <tbody>
                        <?php
                            $table = "SELECT * FROM `tbl_team` WHERE COMP_ID = '$c_id'";
                        ...
                        ?>
                            <tr>
                                ...
                                <form action="" method="post">
                                    <?php
                                        if ($res['ACCESS_CONTROL'] == 1) {
                                            $btn = '<button class="btn btn-info" name="btn-grand"><i class="far fa-check-circle"></i> Grand</button>';
                                        }
                                        else {
                                            $btn = '<button class="btn btn-danger" name="btn-revoke"><i class="fas fa-times"></i> Revoke</button>';
                                        }
                                    ?>

                                </form>
                                <td><a href="update.php?id=<?php echo $res['ID'];?>"><?php echo $btn; ?></a></td>
                            </tr>
                        <?php
                            $sn++;
                            }
