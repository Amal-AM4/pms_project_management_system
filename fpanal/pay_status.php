           ...
           <div class="body-wrapper">
            ...
            <table class="table">
              <thead>
                ...
                <?php
                  $sel = "SELECT tbl_package.TITLE AS TITLE,tbl_package_order.LOGS AS DT,tbl_package.DIS_PRICE AS PRICE,tbl_user.FULL_NAME AS NAME FROM tbl_freelancer,tbl_user,tbl_package,tbl_package_order WHERE tbl_package_order.PACK_ID=tbl_package.ID AND tbl_package.F_ID='$f_id' AND tbl_package_order.USER_ID=tbl_user.ID AND tbl_freelancer.ID='$f_id'";
                  $exe = mysqli_query($conn, $sel);
                  $no = 1;
                  while ($p = mysqli_fetch_assoc($exe)) 
                  {
                ?>
                    <tr>
                      <td><?php echo $no; ?></td>
