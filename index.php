	...
	<section class="container">
		<div class="con-left">
			<div class="con-info">
				...
				<a href="reg_user.php" class="active">Registration</a>
			</div>
		</div>
					...
					?>
							<div class="item">
								...
								<form action="" method="post">
									<a href="view_course_data.php?courseID=<?php echo $fetch['courseID'];?>" class="eye"><i class="far fa-eye"></i></a><button type="submit" class="cart" name="cart">Add Cart</button>
								</form>
							</div>
					<?php
						}
	...
	<section class="dd-about">
		<div class="dd-container">
			<div class="dd-con-left">
				...
				<a href="reg_user.php"><button>Join our team</button></a>
			</div>
