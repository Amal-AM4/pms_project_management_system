...
if(isset($_POST['submit'])) 
{
    ...
    if (!empty($email))
    {
    	$check = "SELECT * FROM `tbl_freelancer` WHERE EMAIL = '$email' AND USER_NAME = '$userid'";
		...
		{
			$ins = "INSERT INTO `tbl_freelancer`(`NAME`, `EMAIL`, `USER_NAME`, `PASSWORD`, `LOGS`, `STATUS`) VALUES ('$name','$email','$userid','$password',now(),1)";
...
<body>
	...
	<section class="user_con">
		...
		<div style="margin-bottom: 10px;">
			...
			<a href="reg_free.php" class="active">Freelancer</a>
		</div>
		<hr><br>
		...
		<center>
			<form action="reg_free.php" method="post" enctype="multipart/form-data">
			<table>
			<tr>
				<td>
		...
		<br>
		<p style="font-size: 14px; font-weight: normal;">Already have an account? <b><a href="fpanal/index.php">Log In</a></b></p>
